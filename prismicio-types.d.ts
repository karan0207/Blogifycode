...
interface PageDocumentData {
   ...
   * - **Placeholder**: Hi guys its a blog website built with nextjs
   * - **API ID Path**: page.new
   * - **Tab**: Main
   * - **Documentation**: https://prismic.io/docs/field#rich-text-title
   */
  new: prismic.RichTextField;
...
export interface SettingDocumentDataNavigationItem {
  ...
  /**
   * CTA Button field in *setting → Navigation*
   *
   * - **Field Type**: Boolean
   * - **Placeholder**: *None*
   * - **Default Value**: false
...
export interface ShowcaseSliceDefaultPrimary {
   ...
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: showcase.primary.buttontext
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
